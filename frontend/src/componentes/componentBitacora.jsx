    ...
    constructor(){
        ...
        this.state={
            ...
            nombresTablas:{
                ...
                taula: "Aula",
                tgrado: "Grado",
                tinscripcion: "Inscripción",
                tlista_vacuna: "Vacuna",
                tretiro: "Retiro",
                tpromocion: "Promocion",
                tprofesor: "Profesor",
                tlista_enfermedad: "Lista de Enfermedades",
                tasignacion_representante_estudiante: "Asignación representante estudiante",
                tasignacion_aula_profesor: "Asignación aula y profesor"
            },
            tablas:[
                ...
                {name: "tinscripcion", value: "Inscripcion"},
                {name: "tlista_vacuna", value: "Vacuna"},
                {name: "tretiro", value: "Retiro"},
                {name: "tpromocion", value:"Promoción"},
                { name: "tprofesor", value:"Profesor"},
                { name: "tlista_enfermedad", value: "Lista de enfermedades"},
                { name: "tasignacion_representante_estudiante", value: "Asignación representante estudiante"},
                { name: "tasignacion_aula_profesor", value: "Asignación aula y profesor"}
            ],
            alerta:{
                color:null,
                mensaje:null,
